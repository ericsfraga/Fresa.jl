# [[file:~/s/research/julia/Fresa.jl/src/fresa.org::gamsf][gamsf]]
...
# [[file:~/s/research/julia/Fresa.jl/src/fresa.org::*solve the multi-objective problem using Fresa][solve the multi-objective problem using Fresa:1]]
using Fresa
a = [0.0;0.0;0.0]
b = [5.0;3.0;3.0]
x0 = [4.0;2.0;2.0]
...
# [[file:~/s/research/julia/Fresa.jl/src/fresa.org::*solve the multi-objective problem using Fresa][solve the multi-objective problem using Fresa:2]]
using PyPlot
...
# [[file:~/s/research/julia/Fresa.jl/src/fresa.org::*solve the single objective version][solve the single objective version:1]]
