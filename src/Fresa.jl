...
# [[file:~/s/research/strawberry/src/fresa.org::pointtype][pointtype]]
"""
...
# [[file:~/s/research/strawberry/src/fresa.org::showpoint][showpoint]]
import Base
...
# [[file:~/s/research/strawberry/src/fresa.org::pointsize][pointsize]]
import Base.size
Base.size(p :: Point) = ()
# pointsize ends here

# [[file:~/s/research/strawberry/src/fresa.org::createpoint][createpoint]]
...
# [[file:~/s/research/strawberry/src/fresa.org::fitness][fitness]]
...
# [[file:~/s/research/strawberry/src/fresa.org::vectorfitness][vectorfitness]]
"""
...
# [[file:~/s/research/strawberry/src/fresa.org::assigndominancefitness][assigndominancefitness]]
...
# [[file:~/s/research/strawberry/src/fresa.org::neighbourarray][neighbourarray]]
...
# [[file:~/s/research/strawberry/src/fresa.org::neighbourfloat][neighbourfloat]]
...
# [[file:~/s/research/strawberry/src/fresa.org::dominates][dominates]]
...
# [[file:~/s/research/strawberry/src/fresa.org::*find Pareto set][find Pareto set:1]]
...
# [[file:~/s/research/strawberry/src/fresa.org::pareto][pareto]]
...
# [[file:~/s/research/strawberry/src/fresa.org::prune][prune]]
...
# [[file:~/s/research/strawberry/src/fresa.org::select][select]]
function select(f)
    l = length(f)
    ind1 = rand(1:l)
    if ind1 == 0
...
# [[file:~/s/research/strawberry/src/fresa.org::solve][solve]]
"""
...
# [[file:~/s/research/strawberry/src/fresa.org::thinout][thinout]]
...
# [[file:~/s/research/strawberry/src/fresa.org::orgtimestamp][orgtimestamp]]
...
# [[file:~/s/research/strawberry/src/fresa.org::rank][rank]]
rank(x :: Any) = length(size(x))
# rank ends here

# [[file:~/s/research/strawberry/src/fresa.org::moduleend][moduleend]]
end
# moduleend ends here
