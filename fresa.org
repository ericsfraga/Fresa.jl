...
* TODO bugs and new features [3/8]                            :noexport:
...
#+begin_src julia
  function solve(f, x0, a, b;     # required arguments
      ...
      @printf("| %9s | %9s | %9s | %9s |", "gen", "npop", "nf", "t (s)")
      for i in 1:nz
          @printf(" z%-8d |", i)
      end
      @printf("\n|-\n")
      for gen in 1:ngen
          ...
          if gen%output == 0
              @printf("| %9d | %9d | %9d | %9.2f |", gen, length(fit), nf, time()-tstart)
