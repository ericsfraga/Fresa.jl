...
* TODO bugs and new features [11/20]                          :noexport:
- [ ] create a =CITATION.cff= file so that people know how to cite this code: https://citation-file-format.github.io/
