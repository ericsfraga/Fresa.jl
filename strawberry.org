...
#+begin_src octave :tangle strawberry_initialise.m
  function strawberry_initialise
    ...
    if isempty (strawberry_version)
      strawberry_version = '2016.10.24 16:54:21';
      mosd_initialise
      moga_initialise
...
#+end_src
* neighbour -- generate a neighbouring (fitness dependent) solution
...
#+begin_src octave
  ...
  try
    ...
    if (strcmp (err.identifier, 'Octave:undefined-function') || strcmp(err.id,'MATLAB:UndefinedFunction'))
