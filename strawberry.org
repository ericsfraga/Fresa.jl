...
[[file:./strawberry-20170204.zip][strawberry-20170204.zip]]
...
#+begin_src octave
  if nz > 1 && ...
    ...
    filename = sprintf('%s-%s-%06d.data', 'strawberry-population', ...
                       ...
                       gen);
    poptrans = pop(:,findpareto(pop(nx+1:nx+nz,:)))';
...
#+begin_src octave :tangle strawberry_initialise.m
  function strawberry_initialise
    ...
    if isempty (strawberry_version)
      strawberry_version = '2017.02.04 16:20:05';
      mosd_initialise
      moga_initialise
