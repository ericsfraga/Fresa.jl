...
[[file:./strawberry-20161129.zip][strawberry-20161129.zip]]
...
#+begin_src octave :noweb yes :tangle strawberry.m
  populationstatistics(best,nx,nz);
...
#+begin_src octave :tangle strawberry_initialise.m
  function strawberry_initialise
    ...
    if isempty (strawberry_version)
      strawberry_version = '2016.11.29 14:24:59';
      mosd_initialise
      moga_initialise
...
#+begin_src octave :tangle populationstatistics.m
  function populationstatistics(p,nx,nz)
    [m n] = size(p);
    feasible = p(end,:) <= 0;
